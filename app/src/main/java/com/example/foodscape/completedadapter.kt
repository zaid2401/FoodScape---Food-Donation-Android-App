...
class completedadapter (private val userList : ArrayList<completeddataclass>, private val context: android.content.Context) : RecyclerView.Adapter<completedadapter.MyViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.ngo_completed_item, parent, false)
